...
function register_post_types() {
  register_post_type('news', [
    'labels' => [
      ...
      'add_news'            => 'Добавить новость', // для добавления новой записи
      'add_news_item'       => 'Добавление новости', // заголовка у вновь создаваемой записи в админ-панели.
      'edit_item'          => 'Редактирование новости', // для редактирования типа записи
      'news_item'           => 'Новый новость', // текст новой записи
   ...
   register_taxonomy('news-categories', 'news', [
    'labels'        => [
      ...
      'add_news_item'                => 'Добавить новую категорию',
      'news_item_name'               => 'Новое название категории',
